...
import 'package:fitcc_mobile_app/Services/api_service.dart';
  ...
  Future<void> _login() async {
    {
      ...
      AuthResponse? response = await authService.loginAction(
          AuthRequest(_usernameController.text, _passwordController.text));
      if (response!.result) {
        // var result = await apiService.get("User/api/userId?GetId=true");
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        // Container(
                        //   child: Text(
                        //     "Ukoliko ne posjedujete racun, izvrite registraciju klikom na dugme ispod",
                        //     style: TextStyle(
                        //         fontFamily: 'Montserrat',
